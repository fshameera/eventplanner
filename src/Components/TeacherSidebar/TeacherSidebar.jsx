  ...
  return (
    <div className='sideBar grid'>
      ...
      <div className='menuDiv'>
        <h3 className='divTitle'>Teacher</h3>
        <h2>School Name</h2>
        <ul className='menuLists grid'>
          ...
          <Link to='teacher/student-list' className='listItem'>
            <p className='menuLink flex'>
              <CgProfile className='icon' />
              <span className='smallText'>Students</span>
            </p>
          </Link>
          <Link to='teacher/addstudent' className='listItem'>
            <p className='menuLink flex'>
              <CgProfile className='icon' />
              <span className='smallText'>Add Student</span>
            </p>
          </Link>
